...
public class RunLocalTestDirectMessage {
    ...
    public static class TestCase {
        ...
        public void addMessageTest() {
            ...
            Assert.assertEquals("Ensure that when you add a message it is being added correctly", user2.getUsername() + ":   " + textMessage + "\n", message.toString());
            ...
            Assert.assertEquals("Ensure that it adds a new message correctly even if you already have a message in it.",
                    user2.getUsername() + ":   " + textMessage + "\n" + user1.getUsername() + ":   " + textMessage2 + "\n", message.toString());
        }
        ...
        public void deleteMessageTest() {
            ...
            Assert.assertFalse("Ensure that the message is not deleted if the wrong user tries to delete it.", removeFalse);
